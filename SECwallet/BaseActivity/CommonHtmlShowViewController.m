...
-(void)initSubViews
{
    ...
    _infoWebView = [[UIWebView alloc]initWithFrame:CGRectMake(titleLb.minX, titleLb.maxY, titleLb.width, kScreenHeight -KNaviHeight-titleLb.maxY -Size(80))];
    ...
    if (_commonHtmlShowViewType == CommonHtmlShowViewType_startRgsProtocol) {
        ...
        /*****************用户协议*****************/
        agreementBtn = [[UIButton alloc] initWithFrame:CGRectMake((kScreenWidth -Size(270))/2, _infoWebView.maxY,Size(270), Size(40))];
        [agreementBtn setTitleColor:TEXT_BLACK_COLOR forState:UIControlStateNormal];
        [agreementBtn setTitle:Localized(@" 我已仔细阅读并同意服务条款", nil) forState:UIControlStateNormal];
        ...
        //继续
        continueBT = [[UIButton alloc] initWithFrame:CGRectMake(titleLb.minX, agreementBtn.maxY +Size(10), titleLb.width, Size(45))];
        [continueBT darkBtnStyle:Localized(@"继续", nil)];
...
-(void)agreementBtnAction:(UIButton *)btn
{
    ...
    if (!agreementBtn.selected) {
        ...
        [continueBT goldBigBtnStyle:Localized(@"继续", nil)];
